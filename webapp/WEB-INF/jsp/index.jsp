			...
			<div class="container">
				...
				<div class="header-cart">  
					<div class="my-account">
						<a href="index-lw"><i class="fa fa-map-marker"
						...
						<div role="tabpanel" class="tab-pane fade in active" id="home"
							...
							<div class="tabcontent-grids">
								<div id="owl-demo" class="owl-carousel">
								   <c:forEach items="${result1}" var="book">
									<div class="item">
										<div class="glry-w3agile-grids agileits">
											<img src="${book.BOOK_IMAGES}"
												height="215.86px" width="179.89px" alt="img">
											<div class="view-caption agileits-w3layouts">
												<h4 style="font-family: SimHei;">${book.BOOK_TITLE}</h4>
												<p>${book.BOOK_PUBLISHER}</p>
												<h4>${book.BOOK_AUTHOR}</h4>

												<form action="detail" method="post">
													<input type="hidden" name="id" value="${book.MARC_REC_NO}" />
