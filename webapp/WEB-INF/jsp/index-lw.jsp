	...
	<div class="header">
		...
		<div class="header-three">
			...
			<div class="container">
				<div class="menu">
					<div class="cd-dropdown-wrapper">
						<a class="cd-dropdown-trigger" href="#0"
							style="font-family: SimHei;">所有论文分类</a>
				...
				<div class="move-text">
					<div class="marquee">
						<a href="https://www.nwsuaf.edu.cn"> 好的书籍是最贵重的珍宝。 <span>书籍就像一盏神灯，它照亮人们最遥远最黯淡的生活道路。
				...
				<div class="bs-example bs-example-tabs" role="tabpanel"
					...
					<ul id="myTab" class=" nav-tabs" role="tablist">
						...
						<li role="presentation"><a href="#james" role="tab"
							id="james-tab" data-toggle="tab"> <i class="fa fa-comments"
								aria-hidden="true"></i>
								<h5>群体推荐</h5>
						</a></li>						
					</ul>
					...
					<table class="table table-striped table-bordered templatemo-user-table">
						...
						<tbody>
						  <form
								...
								<c:forEach items="${result7}" var="result7">
									<tr>
										<td>${result7.subject}</td>
										<td>${result7.author}</td>
										<td>${result7.periodical}</td>
										<td>${result7.publish_time}</td>
										<td>${result7.download_num}</td>
										<td>${result7.quote_num}</td>
									</tr>
								</c:forEach>
							</form>
						</tbody>					
					...
					<table class="table table-striped table-bordered templatemo-user-table">
						...
						<tbody>
							<form
								...
								class="templatemo-login-form" method="post"
								enctype="multipart/form-data">
								<c:forEach items="${result8}" var="result8">
									<tr>
										<td>${result8.subject}</td>
										<td>${result8.author}</td>
										<td>${result8.periodical}</td>
										<td>${result8.publish_time}</td>
										<td>${result8.download_num}</td>
										<td>${result8.quote_num}</td>
									</tr>
								</c:forEach>
							</form>
						</tbody>					
					...
					<table class="table table-striped table-bordered templatemo-user-table">
						...
						<tbody>
							<form
								...
								class="templatemo-login-form" method="post"
								enctype="multipart/form-data">
								<c:forEach items="${result9}" var="result9">
									<tr>
										<td>${result9.subject}</td>
										<td>${result9.author}</td>
										<td>${result9.periodical}</td>
										<td>${result9.publish_time}</td>
										<td>${result9.download_num}</td>
										<td>${result9.quote_num}</td>
									</tr>
								</c:forEach>
							</form>
						</tbody>					
